...
class HydeTemplateTest {
  ...
  void testProcessTemplate()
    ...
    websiteDetails.setTemplateName("hyde");
    ...
    verify(actionProcessorMock, times(10)).processAction(any(), any());
    verify(templateProcessorMock, times(7)).processTemplate(any(), any(), any(), any());
  }
}
